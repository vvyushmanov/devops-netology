...
locals {
  folder_id             = "b1gen0ivt5de5o1t09r6"            # Set your cloud folder ID.
  k8s_version           = "1.23"            # Set the Kubernetes version.
  zone_a_v4_cidr_blocks = "10.1.0.0/16" # Set the CIDR block for subnet.
  sa_name               = "gitlab"            # Set the service account name.
  registry_name         = "netology"            # Set the name of Yandex Container Registry.
}
...
resource "yandex_vpc_security_group_rule" "Rule-5050" {
