...
access_key     ****************FCFU shared-credentials-file    
secret_key     ****************oyFt shared-credentials-file    
...
```shell
$ yc config list                                                                                1 ↵
token: y0_AgAAAAAS****************************nI-Vp_CM
cloud-id: b1g7svmlmt2lon5ffmcb
folder-id: b1gen0ivt5de5o1t09r6
